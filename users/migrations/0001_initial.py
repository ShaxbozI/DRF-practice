    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('new', 'new'), ('code_verified', 'code_verified'), ('done', 'done'), ('up_photo', 'up_photo')], default='new', max_length=31)),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True)),
                ('phone', models.CharField(blank=True, max_length=13, null=True, unique=True)),
                ('photo', models.ImageField(null=True, unique=True, upload_to='user_photos/')),
